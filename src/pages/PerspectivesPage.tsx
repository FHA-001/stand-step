...
const committees = [
  'Insecurity, Poverty & Human Development',
  'Almajiri, Nomadic & Out-of-School Education + Skills Acquisition',
  'Trade, Industry, Commerce & Investment',
  "Technological & Vocational Education + Girls' Education",
  'IDPs & Forced Migration Management'
];
    ...
    <div className="bg-[#f4f0e6]">
      <section className="relative overflow-hidden bg-[#16352b] px-5 pb-20 pt-36 text-[#f4f0e6] sm:px-8 sm:pb-28 lg:px-12">
        ...
        <div className="relative mx-auto max-w-[1200px]">
          ...
          <SectionLabel light>PILLAR 04 / PERSPECTIVES</SectionLabel>
          <h1 className="display mt-6 max-w-4xl text-5xl leading-[1.02] sm:text-7xl">Perspectives</h1>
          <p className="mt-7 max-w-xl text-xl leading-8 text-[#d2d8d2]">People, policy and society.</p>
          <p className="mt-4 max-w-2xl text-sm leading-7 text-[#aebbb3]">Security, poverty, education, investment, human development, migration and inclusive economic growth.</p>
        </div>
      </section>
      ...
      <section className="site-grid py-20 sm:py-28">
        <div className="mx-auto max-w-[1200px] px-5 sm:px-8">
          <div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr]">
            ...
            <p className="max-w-2xl text-base leading-8 text-[#66706b]">The Perspectives pillar addresses the human, social, policy and economic conditions that shape whether technical solutions can create lasting and inclusive impact.</p>
          </div>
