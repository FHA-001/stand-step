    ...
    <div className="bg-[#f4f0e6]">
      <section className="relative overflow-hidden bg-[#16352b] px-5 pb-20 pt-36 text-[#f4f0e6] sm:px-8 sm:pb-28 lg:px-12">
        ...
        <div className="relative mx-auto max-w-[1200px]">
          ...
          <SectionLabel light>PILLAR 02 / TECHNOLOGY</SectionLabel>
          <h1 className="display mt-6 max-w-4xl text-5xl leading-[1.02] sm:text-7xl">Technology</h1>
          <p className="mt-7 max-w-xl text-xl leading-8 text-[#d2d8d2]">Technology that connects and accelerates.</p>
          <p className="mt-4 max-w-2xl text-sm leading-7 text-[#aebbb3]">AI, computing, digital infrastructure, cybersecurity, communication and renewable-energy technologies.</p>
        </div>
      </section>
      ...
      <section className="site-grid py-20 sm:py-28">
        <div className="mx-auto max-w-[1200px] px-5 sm:px-8">
          <div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr]">
            ...
            <p className="max-w-2xl text-base leading-8 text-[#66706b]">The Technology pillar focuses on digital systems, artificial intelligence, communication, cybersecurity, infrastructure and energy technologies that can expand access, resilience and productivity.</p>
          </div>
